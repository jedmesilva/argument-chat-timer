...
export default function ChatApp() {
  ...
  const [timer, setTimer] = useState(10); // Começando com 10 segundos para teste rápido
  const [initialTimer] = useState(10); // Guarda o tempo inicial
  ...
  const handleTryAgain = () => {
    setTimer(10); // Reset para 10 segundos (para teste rápido)
    setTimerFinished(false);
  };

  const handleAddTime = () => {
    setTimer(10); // Adiciona 10 segundos (para teste rápido)
    setTimerFinished(false);
  };
  ...
  const handleTextareaInput = (e) => {
    ...
    // Only increase height if content exceeds the minimum height
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-900 text-white">
      ...
      <div className="flex justify-between items-center p-4 bg-gray-800">
        ...
        {/* Timer ou Botão Tentar Novamente */}
        {timerFinished ? (
          <button 
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        {/* Elemento para rolar automaticamente */}
